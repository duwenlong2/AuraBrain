# 01 · 从一个 Agent 示例认识 Mastra 项目

> 学一个框架，最快的上手方式不是只读文档，而是把一个小项目跑起来、拆开看、再亲手改。这篇记录我对 AuraBrain 中第一个 Mastra Agent 学习示例的整理过程；示例参考了 Mastra Harness 的能力，但代码和实验是项目自己编写、改造的。
...
**本文对应的代码**：`examples/01-basic-agent/`（AuraBrain 学习示例，参考 Harness 并已加详细注释）
...
这个学习示例参考了 Agent Harness 的组织方式，因此包含了不少能力：
